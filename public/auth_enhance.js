(function () {
  ...
  /* ═══════════════════════════════════════════════════════════════════
     SECTION 2 – Load mic.js (mic button is handled in its own file)
  ═══════════════════════════════════════════════════════════════════ */

  function loadMicScript() {
    if (document.getElementById('ra-mic-script')) return;
    var script = document.createElement('script');
    script.id = 'ra-mic-script';
    script.src = '/public/mic.js';
